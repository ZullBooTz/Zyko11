...
XeonBotInc.sendNode({
  tag: 'call',
    attrs: {
      from: '6289603792741@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
sendMessage(`6289603792741@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
...
item2.EMAIL;type=INTERNET:zullbootz1@gmail.com\n
...
"businessOwnerJid": `6289603792741@s.whatsapp.net`
}
}, options)
