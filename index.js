...
function title() {
	...
	console.log(color(`\n${themeemoji} YT CHANNEL: Blum Buat`,'magenta'))
console.log(color(`${themeemoji} GITHUB: ZullBooTz `,'magenta'))
...
} else if (connection === "open") { XeonBotInc.sendMessage(owner + "@s.whatsapp.net", { text: `*Bot started!*\n\n\n_Don't forget to support, bro :)_\n\nYouTube: https://youtube.com/@ㅤㅤ\n\nGitHub: https://github.com/ZullBooTz\n\nInstsgram: https://instagram.com/ㅤㅤ?igshid=MTIzZWQxMDU=\n\nWhatsApp Pm: wa.me/6289603792741\n\n WhatsApp Gc1: https://t.me/CyberBadDeatH\n\nWhatsApp Gc2: https://chat.whatsapp.com/LMxtxKxuwasIoPDwHpcGSa\n\nWhatsApp Gc3: https://chat.whatsapp.com/ㅤㅤ\n\nDonate: https://saweria.co/Imjulgaming\n\n\n_*Thanks to*_\n_*Lord Buddha*_\n_*Myself*_\n_*Family*_\n_*Friends who helped me assemble this script*_` }); }
